...
/**
 * Gap/CFS Feature Page: No wallet / private-key security module.
 * Slug: no-wallet-private-key-security-module
 * Backend: /api/gap-no-wallet-private-key-security-module
 */
export default function NoWalletPrivateKeySecurityModulePage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-wallet-private-key-security-module', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>No wallet / private-key security module.</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>No wallet / private-key security module.</p>
