...
/**
 * Gap/CFS Feature Page: DeFi tax automation
 * Slug: defi-tax-automation
 * Backend: /api/cf-defi-tax-automation
 */
export default function DefiTaxAutomationPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/cf-defi-tax-automation', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>DeFi tax automation</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Track DeFi transactions (yield, impermanent loss, liquidations); auto-calculate taxable events.</p>
