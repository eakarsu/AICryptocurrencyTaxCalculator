...
/**
 * Gap/CFS Feature Page: Tax optimization engine
 * Slug: tax-optimization-engine
 * Backend: /api/cf-tax-optimization-engine
 */
export default function TaxOptimizationEnginePage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/cf-tax-optimization-engine', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Tax optimization engine</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>ML model recommends trading strategies to minimize tax liability while maintaining portfolio risk/return targets.</p>
