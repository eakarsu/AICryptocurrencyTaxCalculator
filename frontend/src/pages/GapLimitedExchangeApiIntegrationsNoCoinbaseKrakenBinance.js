...
/**
 * Gap/CFS Feature Page: Limited exchange API integrations — no Coinbase/Kraken/Binance adapters.
 * Slug: limited-exchange-api-integrations-no-coinbase-kraken-binance
 * Backend: /api/gap-limited-exchange-api-integrations-no-coinbase-kraken-binance
 */
export default function LimitedExchangeApiIntegrationsNoCoinbaseKrakenBinancePage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/gap-limited-exchange-api-integrations-no-coinbase-kraken-binance', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Limited exchange API integrations — no Coinbase/Kraken/Binance adapters.</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Limited exchange API integrations — no Coinbase/Kraken/Binance adapters.</p>
