...
/**
 * Gap/CFS Feature Page: No real-time price-feed integration.
 * Slug: no-real-time-price-feed-integration
 * Backend: /api/gap-no-real-time-price-feed-integration
 */
export default function NoRealTimePriceFeedIntegrationPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-real-time-price-feed-integration', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>No real-time price-feed integration.</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>No real-time price-feed integration.</p>
