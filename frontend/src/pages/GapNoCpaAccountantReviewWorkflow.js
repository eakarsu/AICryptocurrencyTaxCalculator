...
/**
 * Gap/CFS Feature Page: No CPA/accountant review workflow.
 * Slug: no-cpa-accountant-review-workflow
 * Backend: /api/gap-no-cpa-accountant-review-workflow
 */
export default function NoCpaAccountantReviewWorkflowPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-cpa-accountant-review-workflow', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>No CPA/accountant review workflow.</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>No CPA/accountant review workflow.</p>
