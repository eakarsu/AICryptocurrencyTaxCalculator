...
/**
 * Gap/CFS Feature Page: Predictive tax liability forecasting
 * Slug: predictive-tax-liability-forecasting
 * Backend: /api/cf-predictive-tax-liability-forecasting
 */
export default function PredictiveTaxLiabilityForecastingPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/cf-predictive-tax-liability-forecasting', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Predictive tax liability forecasting</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Estimate annual tax bill based on YTD transactions; recommend mid-year tax-loss harvesting.</p>
