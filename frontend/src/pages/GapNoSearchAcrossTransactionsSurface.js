...
/**
 * Gap/CFS Feature Page: No search-across-transactions surface.
 * Slug: no-search-across-transactions-surface
 * Backend: /api/gap-no-search-across-transactions-surface
 */
export default function NoSearchAcrossTransactionsSurfacePage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-search-across-transactions-surface', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>No search-across-transactions surface.</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>No search-across-transactions surface.</p>
