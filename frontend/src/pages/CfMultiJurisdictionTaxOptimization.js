...
/**
 * Gap/CFS Feature Page: Multi-jurisdiction tax optimization
 * Slug: multi-jurisdiction-tax-optimization
 * Backend: /api/cf-multi-jurisdiction-tax-optimization
 */
export default function MultiJurisdictionTaxOptimizationPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/cf-multi-jurisdiction-tax-optimization', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Multi-jurisdiction tax optimization</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Optimize trading across jurisdictions to minimize global tax liability.</p>
